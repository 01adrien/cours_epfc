...
/*
Ecrire un sous-programme qui calcule le nombre de plateaux de longueur 1.
Retourne le nombre de plateaux de longueur = 1; zéro si s est vide.
...
res                1 2 3 2 2 3 2 3 2 2 2 3 4   =>   if (lgPlatCourant == 1) ++res; else if (lgPlatCourant == 2) --res;
 */
public class Plateaux_ex07 {
